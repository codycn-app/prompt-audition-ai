      ...
      <div className="grid h-full grid-cols-5">
        ...
        <div className="flex items-center justify-center">
           <button 
            ...
            className="flex items-center justify-center w-11 h-11 transition-transform duration-300 rounded-full shadow-lg bg-gradient-to-r from-cyber-pink to-cyber-cyan hover:shadow-cyber-glow active:scale-90"
            aria-label="Thêm mới"
          >
